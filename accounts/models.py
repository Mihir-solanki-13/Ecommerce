...
class Cart(BaseModel):
    ...
    razor_pay_order_id = models.CharField(max_length=10,null=True,blank=True)
    razor_pay_payment_id = models.CharField(max_length=10,null=True,blank=True)
    razor_pay_payment_signature = models.CharField(max_length=10,null=True,blank=True)
    ...
    def get_cart_total(self):
        ...
        if self.coupon:
            if self.coupon.mininum_amount < sum(price):
...
class CartItems(BaseModel):
    ...
    def get_product_price(self):
        ...
        if self.sizevariant:
            color_variant_price = self.sizevariant.price
            price.append(color_variant_price)
